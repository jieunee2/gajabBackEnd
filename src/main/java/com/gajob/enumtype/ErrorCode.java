...
//  INVALID_AUTH_TOKEN(UNAUTHORIZED, "권한 정보가 없는 토큰입니다"),
  ...
  DUPLICATE_STUDENT_EMAIL(INTERNAL_SERVER_ERROR, "중복된 교내 이메일이 존재합니다."),
  DUPLICATE_PASSWORD(INTERNAL_SERVER_ERROR, "입력하신 비밀번호가 기존의 비밀번호와 동일합니다."),
  DUPLICATE_OLD_NICKNAME(INTERNAL_SERVER_ERROR, "입력하신 닉네임이 기존의 닉네임과 동일합니다."),
